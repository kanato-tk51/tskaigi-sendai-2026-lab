...
export const FIXED_VITE_EXPECTED_REVISION =
  "p2-vite-expected-20260723-01" as const;
...
const DEFINITIONS: readonly ScenarioDefinition[] = Object.freeze([
  Object.freeze({
    ...
    containerName: "tskaigi-p2-vite-observe-p-20260723-01",
  ...
  Object.freeze({
    ...
    containerName: "tskaigi-p2-vite-observe-c-20260723-01",
    expectedRevision: FIXED_VITE_EXPECTED_REVISION,
  }),
  Object.freeze({
...
function createCommand(
  ...
  return Object.freeze({
    ...
    arguments: Object.freeze([
      "create",
      ...(definition.adapterId === "vite" ? ["--init"] : []),
      "--name",
