...
import { runFixedM2aImageBuildEntry } from "./m2a-transfer-production.mjs";
...
function assertFixedInvocation() {
  ...
  if (
    ...
    throw new Error("M2A_IMAGE_BUILD_INVOCATION_INVALID");
  }
}

async function main() {
  assertFixedInvocation();
  await runFixedM2aImageBuildEntry();
}
