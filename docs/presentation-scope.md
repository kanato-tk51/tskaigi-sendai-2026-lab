...
codegen exact context, separated bindings, and sanitized projection now have
static/unit coverage. The current next task is the fixed codegen staging runner;
