...
| M4 | `threat-model.md`, `architecture.md`, `experiment-matrix.md` | `profiles/**`, `containers/permissive/**`, `containers/constrained/**`, profile integration tests | mount/env/network/child enforcement の実証、manifest skip との区別、host exposure がないこと |
